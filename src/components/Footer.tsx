    ...
    <footer id="footer" className="bg-brand-navy text-white overflow-hidden">
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-16">
        ...
        <div className="mt-16 pt-8 border-t border-white/10 flex flex-col sm:flex-row justify-between items-center text-center gap-4 text-xs text-[#a3b8cc] font-sans">
          ...
          {/* Powered by Reagal badge with logo */}
          <div className="flex items-center space-x-2.5 bg-white border border-white/20 px-4 py-2 rounded-lg">
            <span className="text-[10px] font-mono tracking-widest uppercase text-gray-500">
              Powered by
            </span>
            <img 
              src="/images/Reagal.png" 
              alt="Reagal" 
